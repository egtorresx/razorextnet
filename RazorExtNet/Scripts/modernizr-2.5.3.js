...
window.Modernizr = (function( window, document, undefined ) {
    ...
    // - Firefox shipped moz_InicioSesionedDB before FF4b9, but since then has been mozIndexedDB
    // For speed, we don't test the legacy (and beta-only) InicioSesionedDB
    tests['indexedDB'] = function() {
      return !!testPropsAll("InicioSesionedDB",window);
    };
    ...
    //
    // Codec values from : github.com/NielsLeenheer/html5test/blob/9106a8/InicioSesion.html#L845
